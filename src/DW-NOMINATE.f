...
C  ************************************
      IF(NS.GE.2)THEN
         ...
         CALL WINT(XPLOG,WDERV,NFIRST,NLAST)
      ENDIF
C
C  ************************************
...
C  ************************************
      ...
      CALL SIGMAS(XPLOG,WDERV,NFIRST,NLAST)
C
C  ************************************
C     ROLL CALL PHASE
C  ************************************
...
C  ***************************************************************************
C
      SUBROUTINE SIGMAS(XPLOG,WDERV,NFIRST,NLAST)
      use xxcom_mod
      use mine_mod
      DIMENSION WDERV(99)
      NINC=15
...
C  ***************************************************************************
C
      SUBROUTINE WINT(XPLOG,WDERV,NFIRST,NLAST)
      use xxcom_mod
      use mine_mod
      DIMENSION WDERV(99)
      NINC=15
...
C
     ...
     C                 NFIRST,NLAST,NNMODEL,KXTOT,XBETA,OUTX0,
